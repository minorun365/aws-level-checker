      ...
      <div className="max-w-4xl mx-auto space-y-4">
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              <p>⚠️ このアプリの利用にあたり、メールアドレスを登録いただきます。</p>
              <p>登録されたメールアドレスは、アプリケーション利用状況のモニタリングならびに、常軌を逸した想定外利用などのトラブル発生時における個別連絡のために利用させていただくことがあります。</p>
              <p>その他、マーケティングなどの目的で使われたり、開発者以外の第三者へ共有されることはありません。</p>
            </p>
          </CardContent>
        </Card>
      </div>
