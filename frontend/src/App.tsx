      ...
      <div className="max-w-4xl mx-auto space-y-4">
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              このアプリの利用にあたり、メールアドレスを登録いただきます。<br></br>
              登録されたメールアドレスは、アプリケーション利用状況のモニタリングならびに、常軌を逸した想定外利用などのトラブル発生時における個別連絡のために利用させていただくことがあります。<br></br>
              その他、マーケティングなどの目的で使われたり、開発者以外の第三者へ共有されることはありません。
            </p>
          </CardContent>
        </Card>
      </div>
