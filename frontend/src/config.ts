interface Config {
    ...
    loadApiEndpoint: string;
    loadUrlApiEndpoint: string;
...
export const config: Config = {
    ...
    loadApiEndpoint: import.meta.env.VITE_LOAD_API_ENDPOINT || '',
    loadUrlApiEndpoint: import.meta.env.VITE_LOAD_URL_API_ENDPOINT || '',
